...
<head>
    ...
    <title>Aplikasi Penjualan Shehrazat.id : Login</title>
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                <img width="100" src="{{ asset('assets/img/logo-white.png') }}" alt="logo-shehrazat" />
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Aplikasi Penjualan 🌐</h4>
                        <p class="mb-4">Silahkan login terlebih dahulu untuk mengakses semua fitur</p>

                        <form class="mb-3" action="{{ URL::to('auth/login') }}" method="POST">
                            @csrf
                            <div class="mb-3">
